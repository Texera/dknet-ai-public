...
export class DashboardComponent implements OnInit {
  ...
  protected readonly DASHBOARD_USER_FEEDBACK = DASHBOARD_USER_FEEDBACK;
  ...
  protected readonly DASHBOARD_ADMIN_CU_IMAGE = DASHBOARD_ADMIN_CU_IMAGE;
